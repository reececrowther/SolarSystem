...
import { Material } from 'https://cdn.skypack.dev/three';
...
const earthSphere = new THREE.Mesh(new THREE.SphereGeometry(1.3,50,50), new THREE.MeshLambertMaterial({map: new THREE.TextureLoader().load('Textures/Earth/2k_earth_daymap.jpg') }));
